...
import Service from "../services/product-services.js";
...
import Product from "../model/product.js";
  ...
  const renderList = (phoneList) => {
    ...
    phoneList.forEach((ele) => {
      ...
      <div class="content-overlay"></div>
        <img src="./../../assets/img/${ele.img}" class="card-img" alt="Phone Image" />
  ...
  const renderCart = (cart) => {
    ...
    <div class="product__1">
      <div class="product__thumbnail">
        <img src="./../../assets/img/${ele.product.img}" alt="${ele.product.name}" />
  ...
  window.onload = async () => {
    const phoneList = await service.getPhones();
    console.log("📦 Danh sách sản phẩm từ API:", phoneList); // debug
    renderList(phoneList);
  };
